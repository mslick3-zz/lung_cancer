...
def get_patients(image_directory, labels_path, test_labels_path):
    """
    ...
    test_patients = pd.merge(test_patients, test_labels, how='left', on='id')
    print(list(test_patients)) 
    print(list(test_labels))
    #print(test_patients.ix[:,2])
    return patients_df, train_patients, test_labels
