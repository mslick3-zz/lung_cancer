...
def run():
    ...
    if not os.path.isdir("/datadrive/project_code/cs6250_group_project/processed_images_tutorial"):
        os.makedirs("/datadrive/project_code/cs6250_group_project/processed_images_tutorial")
